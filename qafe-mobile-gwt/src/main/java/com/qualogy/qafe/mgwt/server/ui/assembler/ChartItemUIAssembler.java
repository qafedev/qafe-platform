...
public class ChartItemUIAssembler implements UIAssembler {
	...
	public ComponentGVO convert(Component component, Window currentWindow, ApplicationMapping applicationMapping, ApplicationContext context, SessionContainer ss) {
		...
		if (component != null) {
			if (component instanceof ChartItem) {
				ChartItem c = (ChartItem) component;
				ChartItemGVO voTemp = new ChartItemGVO();
