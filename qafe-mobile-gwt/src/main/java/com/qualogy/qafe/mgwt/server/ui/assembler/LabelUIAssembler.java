...
public class LabelUIAssembler implements UIAssembler {

	public LabelUIAssembler() {
	}
	...
	public ComponentGVO convert(Component object, Window currentWindow,ApplicationMapping applicationMapping, ApplicationContext context, SessionContainer ss) {
		...
		if (object != null) {
			if (object instanceof Label) {
				...
				LabelGVO voTemp  = new LabelGVO();
				UIAssemblerHelper.copyFields(label, currentWindow,voTemp,applicationMapping, context, ss);
				vo =voTemp;
			}
		}
