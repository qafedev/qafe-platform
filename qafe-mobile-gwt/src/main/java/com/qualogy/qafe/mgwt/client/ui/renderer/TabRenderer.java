...
import com.qualogy.qafe.mgwt.client.ui.component.QTab;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.TabGVO;

public class TabRenderer extends AbstractPanelRenderer {
	...
	public UIObject render(ComponentGVO component, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		if (component instanceof TabGVO){
			TabGVO tabGVO = (TabGVO)component;
			widget = super.render(tabGVO, owner, uuid, parent, context, activity);
		}
		return widget;
	}
