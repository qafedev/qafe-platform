...
public class LinkUIAssembler implements UIAssembler {

	public LinkUIAssembler() {
	}
	...
	public ComponentGVO convert(Component object, Window currentWindow,ApplicationMapping applicationMapping, ApplicationContext context, SessionContainer ss) {
		...
		if (object != null) {
			if (object instanceof Link) {
				...
				LinkGVO voTemp  = new LinkGVO();
				UIAssemblerHelper.copyFields(link, currentWindow,voTemp,applicationMapping, context, ss);				
				voTemp.setValue(link.getValue());								
				vo =voTemp;
			}
		}
		return vo;
