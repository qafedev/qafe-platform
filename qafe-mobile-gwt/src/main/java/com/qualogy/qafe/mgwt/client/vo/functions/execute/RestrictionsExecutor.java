...
public class RestrictionsExecutor {
	...
	private Map<String,List<SetRestrictionGVO>> restrictions = new HashMap<String,List<SetRestrictionGVO>>();
	...
	public void add(String key, SetRestrictionGVO setRestrictionGVO) {
		if (!restrictions.containsKey(key)) {
			List<SetRestrictionGVO> setRestrictions = new ArrayList<SetRestrictionGVO>();
			restrictions.put(key, setRestrictions);
		}
		List<SetRestrictionGVO> setRestrictions = restrictions.get(key);
		if (setRestrictions.contains(setRestrictionGVO)) {
			return;
		}
		setRestrictions.add(setRestrictionGVO);
	}
	
	public List<SetRestrictionGVO> get(String key) {
		if (restrictions.containsKey(key)) {
...
//			
//			FunctionsExecutor.getInstance().execute(setPropertyGVO, null);
//			return true;
//		}
//		return false;
//	}
