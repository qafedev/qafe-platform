...
public class QTextFieldText extends MTextBox implements IsTextField {
	...
	public QTextFieldText(String text) {
		setPlaceHolder(text);
		initialize();
	}
	...
	private void initialize() {
		addValueChangeHandler(new ValueChangeHandler<String>() {
			...
			public void onValueChange(ValueChangeEvent<String> event) {
				...
				ComponentHelper.fireDataChange(QTextFieldText.this, newData, null);
			}
		});
		addKeyPressHandler(new KeyPressHandler() {
			@Override
			public void onKeyPress(KeyPressEvent event) {
				ComponentHelper.handleKeyConstraints(QTextFieldText.this, getText(), event, event.getCharCode());
			}
		});
	}
