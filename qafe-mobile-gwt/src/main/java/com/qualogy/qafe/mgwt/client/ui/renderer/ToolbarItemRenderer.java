...
import com.qualogy.qafe.mgwt.client.ui.component.QToolbarItem;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.ToolbarItemGVO;

public class ToolbarItemRenderer extends AbstractComponentRenderer {
	...
	public UIObject render(ComponentGVO component, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		if (component instanceof ToolbarItemGVO) {
			ToolbarItemGVO toolbarItemGVO = (ToolbarItemGVO)component;
			QToolbarItem toolbarItem = new QToolbarItem(toolbarItemGVO.getImageLocation());
			init(toolbarItemGVO, toolbarItem, owner, uuid, parent, context, activity);
			widget = toolbarItem;
		}
