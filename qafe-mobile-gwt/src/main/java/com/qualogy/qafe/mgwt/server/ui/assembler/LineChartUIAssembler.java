...
import com.qualogy.qafe.mgwt.client.vo.ui.CategoryAxisGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.ChartItemGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.LineChartGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.LinearAxisGVO;
import com.qualogy.qafe.mgwt.server.helper.UIAssemblerHelper;
import com.qualogy.qafe.web.util.SessionContainer;

public class LineChartUIAssembler implements UIAssembler {
	...
	public ComponentGVO convert(Component component, Window currentWindow, ApplicationMapping applicationMapping, ApplicationContext context, SessionContainer ss) {
		...
		if (component != null) {
			if (component instanceof LineChart) {
				LineChart c = (LineChart) component;
				LineChartGVO voTemp = new LineChartGVO();
