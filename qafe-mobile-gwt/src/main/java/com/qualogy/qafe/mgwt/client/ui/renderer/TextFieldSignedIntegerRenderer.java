...
import com.qualogy.qafe.mgwt.client.ui.component.QTextFieldSignedInteger;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.TextFieldGVO;

public class TextFieldSignedIntegerRenderer extends AnyTextFieldRenderer {
	...
	public UIObject render(ComponentGVO component, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		if (component instanceof TextFieldGVO) {
			...
			QTextFieldSignedInteger textField = new QTextFieldSignedInteger(textFieldGVO.getDisplayname());
			widget = textField;
		}
		return widget;
	}
