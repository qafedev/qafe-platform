...
import com.qualogy.qafe.mgwt.client.ui.component.QStackPanel;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.StackGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.StackPanelGVO;
...
public class StackPanelRenderer extends AbstractComponentRenderer {
	...
	public UIObject render(ComponentGVO component, String owner, String uuid, String parent, String context, AbstractActivity activity) {		
		...
		if (component instanceof StackPanelGVO) {
			StackPanelGVO stackPanelGVO = (StackPanelGVO)component;
			QStackPanel stackPanel = new QStackPanel();
			init(stackPanelGVO, stackPanel, owner, uuid, parent, context, activity);
			widget = stackPanel;
		}
	...
	protected void init(ComponentGVO component, UIObject widget, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		StackPanelGVO stackPanelGVO = (StackPanelGVO)component;
		QStackPanel stackPanel = (QStackPanel)widget;
		renderChildren(stackPanelGVO, stackPanel, owner, uuid, parent, context, activity);
	}
	
	private void renderChildren(StackPanelGVO component, QStackPanel widget, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		StackGVO[] stacks = component.getStacks();
		if (stacks != null){
			for (int i=0; i<stacks.length; i++){
				StackGVO stackGVO = stacks[i];
				UIObject child = renderChildComponent(stackGVO, owner, uuid, parent, context, activity);
