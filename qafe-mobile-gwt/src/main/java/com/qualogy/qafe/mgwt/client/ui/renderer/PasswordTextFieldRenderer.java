...
import com.qualogy.qafe.mgwt.client.ui.component.QPasswordTextField;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.PasswordTextFieldGVO;

public class PasswordTextFieldRenderer extends AbstractTextComponentRenderer {
	...
	public UIObject render(ComponentGVO component, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		if (component instanceof PasswordTextFieldGVO) {
			PasswordTextFieldGVO passwordTextFieldGVO = (PasswordTextFieldGVO)component;
			QPasswordTextField passwordTextField = new QPasswordTextField(passwordTextFieldGVO.getDisplayname());
			init(passwordTextFieldGVO, passwordTextField, owner, uuid, parent, context, activity);
	...
	protected void init(ComponentGVO component, UIObject widget, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		PasswordTextFieldGVO passwordTextFieldGVO = (PasswordTextFieldGVO)component;
		Object value = passwordTextFieldGVO.getValue();
		if (value == null) {
			return;
		}
		if (widget instanceof HasData) {
			HasData passwordTextField = (HasData)widget;
			passwordTextField.setData(value);
		}
	}
}
