...
import com.qualogy.qafe.mgwt.client.vo.ui.PlotChartGVO;
import com.qualogy.qafe.mgwt.server.helper.UIAssemblerHelper;
import com.qualogy.qafe.web.util.SessionContainer;

public class PlotChartUIAssembler implements UIAssembler {
	...
	public ComponentGVO convert(Component component, Window currentWindow, ApplicationMapping applicationMapping, ApplicationContext context, SessionContainer ss) {
		...
		if (component != null) {
			if (component instanceof PlotChart) {
				PlotChart c = (PlotChart) component;
				PlotChartGVO voTemp = new PlotChartGVO();
