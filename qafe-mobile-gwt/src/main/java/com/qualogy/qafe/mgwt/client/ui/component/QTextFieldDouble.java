...
public class QTextFieldDouble extends MDoubleBox implements IsTextField {
	...
	public QTextFieldDouble(String text) {
		setPlaceHolder(text);
		initialize();
	}
	...
	private void initialize() {
		addValueChangeHandler(new ValueChangeHandler<Double>() {
			...
			public void onValueChange(ValueChangeEvent<Double> event) {
				...
				ComponentHelper.fireDataChange(QTextFieldDouble.this, newData, null);
			}
		});
		addKeyPressHandler(new KeyPressHandler() {
			@Override
			public void onKeyPress(KeyPressEvent event) {
				ComponentHelper.handleKeyConstraints(QTextFieldDouble.this, getText(), event, event.getCharCode());
			}
		});
	}
	...
	public void setData(Object data) {
		Double value = ComponentHelper.toDouble(data, null);
