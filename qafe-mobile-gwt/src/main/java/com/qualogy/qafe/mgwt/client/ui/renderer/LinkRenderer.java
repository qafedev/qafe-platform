...
import com.qualogy.qafe.mgwt.client.ui.component.QLink;
import com.qualogy.qafe.mgwt.client.vo.ui.ComponentGVO;
import com.qualogy.qafe.mgwt.client.vo.ui.LinkGVO;
...
public class LinkRenderer extends AbstractComponentRenderer {
	...
	public UIObject render(ComponentGVO component, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		if (component instanceof LinkGVO) {
			LinkGVO linkGVO = (LinkGVO)component;
			QLink link = new QLink();
			init(linkGVO, link, owner, uuid, parent, context, activity);
			widget = link;
		}
	...
	protected void init(ComponentGVO component, UIObject widget, String owner, String uuid, String parent, String context, AbstractActivity activity) {
		...
		LinkGVO linkGVO = (LinkGVO)component;
		QLink link = (QLink)widget;
		String value = linkGVO.getValue();
		link.setText(value);
	}
}
