...
import com.qualogy.qafe.mgwt.client.vo.ui.ColumnChartGVO;
...
public class ColumnChartUIAssembler implements UIAssembler {
	...
	public ComponentGVO convert(Component component, Window currentWindow, ApplicationMapping applicationMapping, ApplicationContext context, SessionContainer ss) {
		...
		if (component != null) {
			if (component instanceof ColumnChart) {
				ColumnChart c = (ColumnChart) component;
				ColumnChartGVO voTemp = new ColumnChartGVO();
