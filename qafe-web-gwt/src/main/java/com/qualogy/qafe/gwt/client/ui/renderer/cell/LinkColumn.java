...
public abstract class LinkColumn<T> extends Column<T, String> {
  ...
  public LinkColumn(String uuid,String context, String window, String component, String id,String parent,String tooltip,final DataGridColumnGVO column) {
	    super(new LinkCell(uuid,context,window,component,id,parent,tooltip,column));
