...
public class TextFieldGVO extends EditableComponentGVO implements HasVisibleTextI, HasRequiredClass {
	...
	public static final String DEFAULT_HEIGHT = "25px";
	...
	public void setRequiredValidationTitle(String requiredTitle) {
		this.requiredValidationTitle = requiredTitle;
	}
	...
	public void setRequiredValidationMessage(String requiredMessage) {
		this.requiredValidationMessage = requiredMessage;
	}
