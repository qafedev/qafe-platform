...
public class QButtonCell extends AbstractSafeHtmlCell<String> {
  ...
  public QButtonCell(String uuid,String context, String window, String component, String id,String parent, String tooltip,final DataGridColumnGVO column, ButtonGVO bc) {
	    this();
	    this.uuid = uuid;
   ...
   */
  public QButtonCell(SafeHtmlRenderer<String> renderer) {
  ...
  protected void render(Context context, SafeHtml value, SafeHtmlBuilder sb) {
	  sb.appendHtmlConstant("<button type=\"button\"  w style=\"width:"+column.getWidth()+";height:"+column.getHeight()+";\" tabindex=\"-1\" " + addToolTip(tooltip)+" >");
