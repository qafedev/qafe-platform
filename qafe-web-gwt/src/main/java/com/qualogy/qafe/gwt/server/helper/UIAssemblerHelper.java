...
import com.qualogy.qafe.gwt.client.vo.ui.HasVisibleTextI;
...
import com.qualogy.qafe.gwt.server.ui.assembler.ConditionUIAssembler;
import com.qualogy.qafe.gwt.server.ui.assembler.ConditionalStyleUIAssembler;
...
public class UIAssemblerHelper {
	...
	public static void manageInternationalisation(Component component, ComponentGVO vo, ApplicationMapping applicationMapping, SessionContainer sc) {
		if (component instanceof HasVisibleText && vo instanceof HasVisibleTextI){
			...
			if (hasVisibleText.getMessageKey()!=null && hasVisibleText.getMessageKey().length()>0){
				if (ApplicationCluster.getInstance().get(applicationMapping)!=null){
					...
					hasVisibleText.setDisplayname(MessagesHandler.getMessage(applicationMapping, dataId, hasVisibleText.getMessageKey(), hasVisibleText.getDisplayname()));
