...
import com.qualogy.qafe.gwt.client.vo.ui.PlotChartGVO;

public class PlotChartRenderer implements GWTUIRenderer {
	...
	public UIObject render(ComponentGVO component, String uuid, String parent, String context) {
		...
		String width = "250px";
		if(component != null){
			if (component instanceof PlotChartGVO) {
				PlotChartGVO gvo = (PlotChartGVO)component;
				...
				Plot2D linePlot = new Plot2D(Plot2D.PLOT_TYPE_SCATTER);
