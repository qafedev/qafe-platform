...
public class StoreClearHandler extends AbstractBuiltInHandler {
     ...
     * @param target the location of the store (pipe, user, global)
     * */
    protected void storeClear(StoreClearGVO storeClearGVO, String appId, String windowId, String eventSessionId) {
