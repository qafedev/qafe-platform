...
public class DatagridDownloadServlet extends HttpServlet {
	private  final static Log logger = LogFactory.getLog(DatagridDownloadServlet.class);
	public final static String FORM_PARAMETER_DELIMITER="delimeter";
	...
	protected void doPost(HttpServletRequest request,
		...
		if (uuid!=null){
			...
			//String exportPDFLocation = ApplicationCluster.getInstance().getConfigurationItem("reports.export.default");
