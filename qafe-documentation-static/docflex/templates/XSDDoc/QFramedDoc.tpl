...
LAST_UPDATE='2009-02-07 01:37:14'
DESIGNER_TOOL='DocFlex SDK 1.x'
DESIGNER_LICENSE_TYPE='Filigris Works Team'
APP_ID='docflex-xml-xsddoc2'
APP_NAME='DocFlex/XML XSDDoc'
APP_VER='2.1.0'
APP_AUTHOR='Copyright \u00a9 2006-2010 Qualogy Consultancy B.V.,\nRokesh Jankie. All rights reserved.'
...
<TEMPLATE_PARAMS>
	...
	PARAM={
		...
		param.description='Specifies whether to generate the <b><i>List of Containing Elements</i></b>.\n<p>\nThis list is generated only for Element Components, where it appears under the heading <i>"Included in content model of elements"</i>. The list shows all elements whose content models explicitly include the given element. (Here, "explicitly" means that element wildcards are not be taken onto account.)\n<p>\n<b>Applies To:</b>\n<blockquote>\nGlobal & Local Elements\n</blockquote>';
		param.featureType='pro';
		param.type='boolean';
		param.default.value='true';
	}
	...
	PARAM={
		...
		param.description='Specifies whether to generate the <b><i>Usage Locations</i></b> report.\n<p>\nThis section shows where and how the given component is used within this and other XML Schemas included in the documentation.\n<p>\n<b>Applies To:</b>\n<blockquote>\nAll global components\n</blockquote>';
		param.featureType='pro';
		param.type='boolean';
		param.default.value='true';
	}
	PARAM={
		param.name='doc.comp.lists.defs';
	...
	PARAM={
		...
		param.title.style.bold='true';
		param.description='Specifies whether to generate the <b><i>Attribute Detail</i></b> section, which documents the attributes declared for the given component. There are following choices:\n<p>\n<i>"all"</i>\n<blockquote>\nInclude all attributes associated with the given component. Both the attributes defined directly within this component itself and those inherited from other components will be documented together. This will result in repeating of the details of the same attributes defined in a certain component across the <i>component documentation</i> generated for each of its descendant components.\n</blockquote>\n\n<i>"own only"</i>\n<blockquote>\nDocument only those attributes that are defined directly within the definition of this component. Any other attributes that are inherited from other components will be documented only once together with their parent components (where they are defined). Only hyperlinks to the corresponding attribute details will lead from this component documentation (e.g. from the <i>XML Representation Summary</i>). This setting will produce more compact documentation!\n</blockquote>\n\n<i>"none"</i>\n<blockquote>\nDo not generate the <i>"Attribute Detail"</i> section.\n</blockquote>\n\n<p>\n<b>Applies To:</b>\n<ul>\n<li>Elements</li>\n<li>Complex Types</li>\n<li>Attribute Groups</li>\n</ul>\n\n<b>Nested Parameter Group:</b>\n<dl><dd>\nControls documenting of a particular attribute.\n</dd></dl>';
		param.featureType='pro';
		param.grouping='true';
		param.grouping.defaultState='collapsed';
		param.type='enum';
		param.enum.values='all;own;none';
		param.enum.displayValues='all;own only;none';
		param.default.value='own';
		param.default.value.limited='all';
	}
	PARAM={
	...
	PARAM={
		...
		param.featureType='pro';
		param.type='boolean';
		param.default.expr='hasParamValue("doc.comp.attributes", "all")';
	}
	PARAM={
	...
	PARAM={
		param.name='doc.comp.attributes.type.deriv.simpleContent.annotation';
		param.title='Annotations';
		param.description='Specifies whether the datatype derivation details should include all annotations (e.g. facet annotations)';
		param.featureType='pro';
		param.type='boolean';
	...
	PARAM={
		...
		param.title.style.bold='true';
		param.description='Specifies whether to generate the <b><i>Content Element Detail</i></b> section, which documents the elements declared in the element content model of the given component. There are following choices:\n\n<p>\n<i>"all"</i>\n<blockquote>\nInclude all content elements declared in the content model of this component. Both the elements directly defined within this component itself and those inherited from other components will be documented together. This will result in repeating of the details of the same content elements defined in a certain component across the <i>component documentation</i> generated for each of its descendant components.\n</blockquote>\n\n<i>"own only"</i>\n<blockquote>\nDocument only those content elements that are defined directly within the definition of this component. Any other content elements that are inherited from other components will be documented only once together with their parent components (where they are defined). Only hyperlinks to the corresponding content element details will lead from this component documentation (e.g. from the <i>XML Representation Summary</i>). This setting will produce more compact documentation!\n</blockquote>\n\n<i>"none"</i>\n<blockquote>\nDo not generate the <i>"Content Element Detail"</i> section.\n</blockquote>\n\n<p>\n<b>Applies To:</b>\n<ul>\n<li>Element Documentation</li>\n<li>Complex Type Documentation</li>\n<li>Element Group Documentation</li>\n</ul>\n\n<b>Nested Parameter Group:</b>\n<dl><dd>\nControls documenting of a particular content element.\n</dd></dl>';
		param.featureType='pro';
		param.grouping='true';
		param.grouping.defaultState='collapsed';
		param.type='enum';
	...
	PARAM={
		...
		param.featureType='pro';
		param.type='boolean';
		param.default.expr='hasParamValue("doc.comp.contentElements", "all")';
	}
	PARAM={
	...
	PARAM={
		param.name='doc.comp.contentElements.type.deriv.simpleContent.annotation';
		param.title='Annotations';
		param.description='Specifies whether the datatype derivation details should include all annotations (e.g. facet annotations)';
		param.featureType='pro';
		param.type='boolean';
	...
	PARAM={
		...
		param.description='Specify whether to add namespace prefixes to any XML names appearing in the generated documentation.\n<p style="margin:0">\n<table border="1">\n<tr><td><font face="Dialog" size="-1">\nAs you may know, each XML name is not just a string. Rather, it is a vector of two values: { <i>namespace URI</i>, <i>local name</i> }\n</font>\n</td></tr>\n</table>\n<p>\nAny namespace prefixes used in the output documentation originate from the namespace URI/prefix bindings declared in the source XSD files.\nFor a particular XML name, its namespace prefix is generated according to the binding for the given namespace found the nearest to the documentation context where that XML name appears.\n<p>\n<u>Example</u>:\n<p>\nSuppose you generate documentation for two XML schemas: <b>schema1</b> and <b>schema2</b>.\n<p>\nschema1 is targeted to the namespace with <code><i>\'namespace_uri_1\'</i></code>, which is bound in that schema file to the prefix <code><i>\'myns\'</i></code>. That schema defines the <i>MyType</i> type component.\n<p>\nschema2 is targeted to a different namespace, however, it uses <i>MyType</i> imported from the schema1. To reference to that type, schema2 binds the <code><i>\'namespace_uri_1\'</i></code> to the prefix <code><i>\'ns1\'</i></code>, so <i>MyType</i> will look in it as <code><i>\'ns1:MyType\'</i></code>.\n<p>\nSo, what will you get about <i>MyType</i> in the documentation (when this parameter is selected)?\n<p>\nIn the documentation for schema1 you will see <code><i>\'myns:MyType\'</i></code>. In the documentation for schema2, you will see <code><i>\'ns1:MyType\'</i></code>. (Although, both names will be connected via hyperlinks.)';
		param.featureType='pro';
		param.type='boolean';
		param.default.value='true';
	}
...
CHECKSUM='eDkw4drwCKQE2nMK43mjczWxkjhBRPxbstxN3OjEZro'
</DOCFLEX_TEMPLATE>
