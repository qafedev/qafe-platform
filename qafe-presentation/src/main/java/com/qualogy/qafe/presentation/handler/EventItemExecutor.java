...
import com.qualogy.qafe.presentation.handler.executors.AuthenticateExecute;
import com.qualogy.qafe.presentation.handler.executors.AuthorizeExecute;
...
public class EventItemExecutor {
	...
	private EventItemExecutor(){
		...
		EXECUTOR_MAP.put(Authenticate.class, AuthenticateExecute.class);
		EXECUTOR_MAP.put(Authorize.class, AuthorizeExecute.class);
