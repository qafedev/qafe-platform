...
import com.qualogy.qafe.business.action.SwitchStatementExecuter;
...
public class SwitchStatementExecute extends SwitchStatementExecuter implements ExecuteEventItem {
	
	public final static Logger logger = Logger.getLogger(SwitchStatementExecute.class.getName());
