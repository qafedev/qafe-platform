...
public class Ux2Dos {
	 ...
	 * 
	 * <p>
	 * Reads each specified file in sequence and writes it to System.out
	 * (standard output) converting all occurrences of the pattern [\r]*[\n]
	 * (any number of carriage returns followed by a line feed) to a CRLF
	 * sequence.
	 * 
	 * <p>
	 * If no input file is given or if the argument - is encountered, ux2dos
	 * reads from System.in (standard input). Standard input can be combined
	 * with other files.
	 * 
	...
	/*public static void main(String[] args) throws IOException {
		...
		if (args.length == 0) {
			ux2dos(new BufferedReader(new InputStreamReader(System.in)), out);
		}
