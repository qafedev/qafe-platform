...
public class LayoutProperties {
	 ...
	 * 
	 */
	protected Integer x = Integer.valueOf(0);

	/**
	 * 
	 */
	protected Integer y = Integer.valueOf(0);

	/**
	 * 
	 */
	protected Integer width = Integer.valueOf(0);

	/**
	 * 
	 */
	protected Integer height =Integer.valueOf(0);
