 ...
 * @author 
 */
public class PostBindException extends RuntimeException {

	private static final long serialVersionUID = -4322004082879602506L;

	public PostBindException(String arg0) {
		super(arg0);
	}

	public PostBindException(Throwable arg0) {
		super(arg0);
	}

	public PostBindException(String arg0, Throwable arg1) {
		super(arg0, arg1);
	}
