...
public class SwitchResult implements Serializable, Validatable{
     ...
     */
    protected Parameter valueParameter;
    ...
    public SwitchResult(Parameter valueParameter) {
        super();
        this.valueParameter = valueParameter;
    }

    public SwitchResult(Parameter valueParameter, List<ResultItem> resultItems) {
        this(valueParameter);
    ...
    public void setValue(Parameter valueParameter) {
        this.valueParameter = valueParameter;
    }
