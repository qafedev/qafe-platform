...
<TEMPLATE_PARAMS>
	...
	PARAM={
		...
		param.title='All Component Summary';
		param.description='Specify whether each <i>All Component Summary</i> documentation should start from a new page.\n<p>\n<b>See Also:</b>\n<ul>\n<li><i>Generate Details | All Component Summary</i></li>\n<li><i>Details | All Component Summary</i></li>\n</ul>';
		param.type='boolean';
		param.default.value='true';
	}
	PARAM={
...
CHECKSUM='aWwoF2wXEh23plTsvsitGRmj5pDyuaNzKUU1FZsCaLs'
</DOCFLEX_TEMPLATE>